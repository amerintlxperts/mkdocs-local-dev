...
if command -v python3 &> /dev/null; then
    ...
    # Check if it's a beta or pre-release version
        ...
        echo ""
        echo "Please uninstall the beta version and install Python 3.11:"
        echo "   1. If installed via Homebrew: brew uninstall python@3.14"
        echo "   2. If installed via python.org: Use the Python installer's uninstall option"
        echo "   3. Install Python 3.11 via Homebrew: brew install python@3.11"
        echo "   4. Or download from: https://www.python.org/downloads/release/python-3115/"
        echo ""
        echo "Restart terminal and re-run this script after installation."
        echo ""
        exit 1
    else
        echo "ERROR: Python 3.11 is required for this script."
        ...
        echo "     Download from: https://www.python.org/downloads/release/python-3115/"
        echo ""
        echo "Restart terminal and re-run this script after installation."
        echo ""
        exit 1
